...
\textit{As previously reported, we observed the epi/mesopelagic community stratification according to water column depth for dsDNA-viruses, gyruses, prokaryotes, and pico-eukaryotes.}  (Supplementary Figure \ref{fig:nmds}).
...
\begin{suppfigure}[ht]
    \centering
    \includegraphics[scale=0.8,angle=90,origin=c]{images/Trees_OTU_sup.pdf}
    \caption{Taxonomy Trees}
    \label{fig:tax_trees_sup}
\end{suppfigure}
